                                        ...
                                        children: [
                                          ...
                                          Row(
                                            mainAxisAlignment:
                                                MainAxisAlignment.spaceEvenly,
                                            children: [
                                              if (userdata!.quizScore! > 5)
                                                Image(
                                                    image: AssetImage(
                                                        'assets/image/6/0.png')),
                                              if (userdata!.quizScore! > 15)
                                                Image(
                                                    image: AssetImage(
                                                        'assets/image/7/0.png')),
                                              if (userdata!.quizScore! > 25)
                                                Image(
                                                    image: AssetImage(
                                          ...
                                          Row(
                                            mainAxisAlignment:
                                                MainAxisAlignment.spaceEvenly,
                                            children: [
                                              if (userdata!.quizScore! > 35)
                                                Image(
                                                    image: AssetImage(
                                                        'assets/image/5/0.png')),
                                              if (userdata!.quizScore! > 45)
                                                Image(
                                                    image: AssetImage(
                                                        'assets/image/4/0.png')),
                                              if (userdata!.quizScore! > 95)
                                                Image(
                                                    image: AssetImage(
                                                        'assets/image/3/0.png')),
                                              if (userdata!.quizScore! < 95)Text("No more  Badges yet")
                                            ],
                                          ),
                                        ],
                                      ),
                                            ...
                                            children: [
                                              ...
                                              Center(
                                                child: Padding(
                                                  ...
                                                  child: StreamBuilder<
                                                      DocumentSnapshot>(
                                                    // Replace 'userScores' and 'userId' with your Firestore collection and document ID
                                                    stream: FirebaseFirestore
                                                        .instance
                                                        .collection('Users')
                                                        .doc(userEmail) // Specify the document ID
                                                        .snapshots(),
                                                    builder:
                                                        (context, snapshot) {
                                                      if (snapshot
                                                          ...
                                                          ConnectionState
                                                              .waiting) {
                                                        // Show a loading indicator while waiting for Firestore data
                                                      ...
                                                      // Retrieve the score and total score from Firestore
                                                      final data =
                                                          snapshot.data!.data()
                                                              as Map<String,
                                                                  dynamic>;
                                                      final int currentScore = data['Quizscore'] ?? 0;
                                                      final int totalScore = 100; // Default or actual total score
                                                          ...
                                                          Container(
                                                            ...
                                                            child: Stack(
                                                              ...
                                                              children: [
                                                                ...
                                                                // Display the current score percentage in the center
                                                                Text(
